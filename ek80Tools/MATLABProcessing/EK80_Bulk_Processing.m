...
dlgTitle    = 'Outputs';
dlgQuestion = 'Output processed volume scattering?';
dlg.Sv = questdlg(dlgQuestion,dlgTitle,'Yes','No', 'Yes')
dlg.TS = 'No';
...
%                     [sp, phi] = TSCalc(channel, ComplexVoltage, para, w, range, ping);
%                     Sp{channel}(:,ping) = sp;
%                     Phi{channel}(:,ping) = phi;
%                 end
                
            end
        end
        %para{channel}.fnom = fnom;
