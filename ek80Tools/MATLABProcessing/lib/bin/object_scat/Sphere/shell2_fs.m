% scattering by a sphere in an elastic medium with an elastic shell 
% and an elastic core, a is the outer radius and b is the inner radius
...
%  para(4) = rho1 :  density of the surrounding medium (medium 1)
%  para(5) = rho2 :  density of the shelled medium (medium 2)
%  para(6) = rho3 :  density of the inner medium	(medium 3)
%  para(7) = cL1  :  longitudinal sound speed in medium 1
%  para(8) = cL2  :  longitudinal sound speed in medium 2
%  para(9) = cL3  :  longitudinal sound speed in medium 3
%  para(10) = cT1 :  transverse sound speed in medium 1
%  para(11) = cT2 :  transverse sound speed in medium 2
%  para(12) = cT3 :  transverse sound speed in medium 3
%  para(13) = r   :  ratio of the inner to outer radius = b/a
%  para(14)= theta0  for proc_flag = 1  (degree)
%          = ka0     for proc_flag = 2 
...
if ( proc_flag == 1)
   ...
   pn=Pn(n,x);
   nl=(2*n+1);
   jnL1=sphbeslj(n,kaL1);
   jnT1=sphbeslj(n,kaT1);
   yn1=sphbesly(n,ka1);
