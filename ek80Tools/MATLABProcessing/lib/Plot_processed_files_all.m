% function  plot_processed_files_all
%
%   plot ALL processed files in matlab output directory
...
save_plots = 0;     % save the plots,  or not...
GUIselect = 0;      %  Do ALL ES files, No GUI
...
if GUIselect
    [filename, filepath] = uigetfile({'*.mat'},'Pick a matlab ES files to plot','MultiSelect','on');
...
for ifile = proc_files       
    ...
    % this assumes all 4 frequencies are present in this file!
    switch ID
        case 'ES70'
